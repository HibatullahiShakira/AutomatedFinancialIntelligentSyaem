...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('OWNER', 'Owner'), ('ACCOUNTANT', 'Accountant'), ('VIEWER', 'Viewer'), ('SALESPERSON', 'Salesperson')], max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.AddField(
            model_name='user',
            name='tenants',
            field=models.ManyToManyField(help_text='Tenants this user has access to', related_name='users', through='core.UserTenant', to='core.tenant'),
        ),
    ]
